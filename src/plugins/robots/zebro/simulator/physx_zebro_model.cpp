...
namespace argos {
   ...
   CPhysXZebroModel::CPhysXZebroModel(CPhysXEngine& c_engine,
      ...
      RegisterAnchorMethod(GetEmbodiedEntity().GetOriginAnchor(),
                           &CPhysXZebroModel::UpdateOriginAnchor);
   }

   /****************************************/
   /****************************************/

   void CPhysXZebroModel::Reset() {
      /* Reset bodies */
   ...
   void CPhysXZebroModel::UpdateFromEntityStatus() {
      /* Do we want to move? */
   ...
   void CPhysXZebroModel::UpdateOriginAnchor(SAnchor& s_anchor) {
   ...
   REGISTER_STANDARD_PHYSX_OPERATIONS_ON_ENTITY(CEPuckEntity, CPhysXZebroModel);
