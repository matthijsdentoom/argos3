/**
 * @file <argos3/plugins/robots/zebro/control_interface/ci_zebro_proximity_sensor.cpp>
 *
 * @author Matthijs den Toom <thijsco4@gmail.com>
 */

#include "ci_zebro_proximity_sensor.h"
...
namespace argos {
   ...
   CCI_ZebroProximitySensor::CCI_ZebroProximitySensor() :
      m_tReadings(24) {
   ...
   const CCI_ZebroProximitySensor::TReadings& CCI_ZebroProximitySensor::GetReadings() const {
     return m_tReadings;
   }
...
#ifdef ARGOS_WITH_LUA
   void CCI_ZebroProximitySensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_ZebroProximitySensor::ReadingsToLuaState(lua_State* pt_lua_state) {
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_ZebroProximitySensor::SReading& s_reading) {
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_ZebroProximitySensor::TReadings& t_readings) {
      if(! t_readings.empty()) {
